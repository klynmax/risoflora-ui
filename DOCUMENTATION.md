...
2. [Avatar](#avatar)
3. [AvatarGroup](#avatarGroup)
4. [AvatarName](#avatarName)
5. [Button](#button)
6. [Container](#container)
7. [Divider](#divider)
8. [Grid](#grid)
9. [Cores do tema](#cores)
...
|  `size`   |    `xs`<br/>`sm`<br/>`md`<br/>`lg`    |    `md`    | Define o tamanho do avatar.                                                                  |
...
| `border`  |               `boolean`               |  `false`   | Define se haverá uma borda ao redor da imagem.                                               |

<div id='avatarGroup'/>

# AvatarGroup

Usado para exibir um grupo de imagens.

#### Importar

```
import AvatarGroup from "risoflora-ui";
```
...
| :-------: | :-----------------------------------: | :--------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  `style`  |                `Array`                |            | É usado para digitar o objeto de estilo que consiste em nomes e valores de propriedades CSS.                                                                                                             |
| `variant` | `circular`<br/>`square`<br/>`rounded` | `circular` | Forma do avatar.                                                                                                                                                                                         |
|  `size`   |    `xs`<br/>`sm`<br/>`md`<br/>`xl`    |            | Tamanho do elemento.                                                                                                                                                                                     |
|   `src`   |                `Array`                |            | Array de imagem.                                                                                                                                                                                         |
|   `alt`   |               `string`                |            | Fornece um elemento alt ao componente.                                                                                                                                                                   |
|  `group`  |               `boolean`               |   `true`   | Define o componente como group. (Fazer a refatoração deste componenete pois não faz sentido esse atributo. Visto que ele já é um componente de avatar em grupo não será necessário dier que ele é true.) |
| `spacing` |               `boolean`               |   `true`   | Define se haverá espaço entre os avatares.                                                                                                                                                               |
